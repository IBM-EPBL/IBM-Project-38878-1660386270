...
class Video(object):
    def __init__(self):
        ...
        self.model = load_model('Real-Time.h5')  # Execute IBM Trained Model
    ...
    def get_frame(self):
        ...
        self.y = pred[0]
        cv2.putText(frame, 'The Predicted Alphabet is: ' + str(self.index[self.y]), (100, 50), cv2.FONT_HERSHEY_SIMPLEX,
                    1, (0, 0, 0), 3)
